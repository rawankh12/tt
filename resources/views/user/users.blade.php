            ...
            <div class="col-md-4 col-12 mb-4">
                <div class="card custom-card position-relative">
                    <div class="card-body">
                            ...
                            <p class="card-text"><strong></strong> {{ $user->phone }}</p>
                            <p class="card-text"><strong></strong> {{ $user->email }}</p>
                            <div class="mt-4 d-flex justify-content-center">
                                <form action="{{ route('users.block', $user->id) }}" method="POST" onsubmit="return confirmblock(event)">
                                    @csrf
