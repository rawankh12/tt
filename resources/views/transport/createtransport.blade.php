    ...
    <div class="table justify-center" style="border-color: black">
        ...
        <form method="POST" action="{{ route('transport.store') }}">
            ...
            <div class="table-body">
                ...
                <select class="form-control custom-select" id="section_id" name="section_id">
            ...
            <div class="table-body">
                ...
                <select class="form-control custom-select" id="type_tra_id" name="type_tra_id">
                    <option value="" disabled selected></option>
                    @foreach ($type_tras as $type_tra)
                    <option value="{{ $type_tra->id }}">
                        {{ $type_tra->name_t }}
                    </option>
                @endforeach
                </select>
